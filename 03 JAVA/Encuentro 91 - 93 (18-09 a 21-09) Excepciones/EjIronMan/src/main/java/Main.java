/* ARMADURA IRON MAN:
Una clase llamada Armadura que modele toda la información y las acciones que pueden
efectuarse con la Armadura de Iron Man.
...
de energía a la armadura. La batería es parte de la armadura.
...
transformaciones.
3 gigajulios por segundo. El equivalente en energía química a 120 barriles de petróleo por minuto o
 3,3 megavatios-hora.
Sufriendo Daños
...
public class Main {
    ...
    ArmorService service = new ArmorService();
    Armor a1 = service.createArmor();
    service.batteryStatus(a1);
    service.walk(a1,5);
    service.batteryStatus(a1);
    service.run(a1,10);
    service.batteryStatus(a1);
